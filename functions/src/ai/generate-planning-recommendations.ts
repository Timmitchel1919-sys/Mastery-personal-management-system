...
/** Assisted planning-cascade suggestions. See `docs/AI_ARCHITECTURE.md`. */
export const generatePlanningRecommendations = onCall(
  { ...DEFAULT_RUNTIME_OPTIONS, secrets: [ANTHROPIC_API_KEY], timeoutSeconds: 60 },
  (request) =>
    handleAiIntent("planning-recommendations", request, {
      db: adminDb(),
